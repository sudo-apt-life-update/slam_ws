#!/usr/bin/env python3
# [COPIED 2026-08-19] from waypoint_follow_ws/src/g1_walk/g1_walk/odom_bridge.py
...
from g1_locomotion.loco_protocol import LocoError, ODOM_PORT, ODOM_SIZE, decode_odom
from g1_locomotion.single_instance import AlreadyRunning, claim
